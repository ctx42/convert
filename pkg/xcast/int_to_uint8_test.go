...
func Test_IntToUint8_tabular(t *testing.T) {
	tt := []struct {
		testN string
	...
	for _, tc := range tt {
		t.Run("IntToUint8 "+tc.testN, func(t *testing.T) {
			// --- When ---
			have, err := IntToUint8(tc.value)
		...
		t.Run("IntToByte "+tc.testN, func(t *testing.T) {
			// --- When ---
